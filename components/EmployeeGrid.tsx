            ...
            <div className="space-y-2 text-sm">
              {visibleColumns?.contact && (
                <>
                  <div>
                    ...
                    <p className="text-gray-900 truncate">{employee.user.email}</p>
                  </div>
                  <div>
              ...
              {visibleColumns?.department && (
                <div>
                  ...
                  <p className="text-gray-900">{employee.department?.name || 'Not assigned'}</p>
                </div>
              )}
                  ...
                  <p className="text-gray-900">
                    {employee.address && employee.city ? (
                      <>
                        ...
                        <span className="text-xs text-gray-500 block">{employee.country}</span>
                      </>
                    ) : (
                      'Not provided'
                    )}
                    ...
                    {employee.emergencyContactName ? (
                      <>
                        ...
                        {employee.emergencyContactRelation && (
                          <span className="text-xs text-gray-500 block">({employee.emergencyContactRelation})</span>
                        )}
                        <span className="text-xs text-gray-500 block">{employee.emergencyContactPhone}</span>
                      </>
                    ) : (
                      'Not provided'
                    )}
